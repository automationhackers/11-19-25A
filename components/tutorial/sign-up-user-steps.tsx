...
export function SignUpUserSteps() {
  return (
    <ol className="flex flex-col gap-6">
      ...
      <TutorialStep title="Create your first user">
        <p>
          Head over to your{" "}
          <Link
          ...
          and create your first user in the Authentication section. User sign-up
          is managed directly through Supabase for security.
        </p>
      </TutorialStep>
    </ol>
  );
